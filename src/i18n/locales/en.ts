...
const en: TranslationDict = {
  ...
  property: {
    ...
    photoFullscreen: 'View fullscreen',
    photoClose: 'Close',
    photoZoomIn: 'Zoom in',
  ...
  submit: {
    ...
    nearestLandmarkLabel: 'Nearest landmark / address',
    nearestLandmarkPlaceholder: 'e.g. Near Grand Mosque, Next to City Star...',
    floorsCountLabel: 'Number of floors',
    floorsCountPlaceholder: 'How many floors?',
    floorLevelLabel: 'Floor level',
    floorLevelPlaceholder: 'Which floor?',
    bedroomsLabel: 'Bedrooms',
    bedroomsPlaceholder: 'How many?',
    bathroomsLabel: 'Bathrooms',
    bathroomsPlaceholder: 'How many?',
    facingLabel: 'Facing',
    facingPlaceholder: 'Select direction',
    areaPlaceholder: 'Area (m²)',
    frontageLabel: 'Frontage (m)',
    frontagePlaceholder: 'Front width in meters (numbers only)',
    streetWidthLabel: 'Street width (m)',
    streetWidthPlaceholder: 'Street width in meters',
    streetWidth1Label: 'Street 1 (m)',
    streetWidth2Label: 'Street 2 (m)',
    isCornerLabel: 'Corner property (2 street faces)',
    ...
    existingImages: 'Current Property Images',
  },
  dashboard: {
    title: 'Dashboard',
    analytics: 'Analytics',
