...
const ar: TranslationDict = {
  ...
  submit: {
    ...
    nearestLandmarkLabel: 'أقرب نقطة دالة',
    nearestLandmarkPlaceholder: 'العنوان أو أقرب نقطة دالة...',
    ...
    frontageLabel: 'الواجهة (متر)',
    frontagePlaceholder: 'كم متر واجهة العقار؟ (أرقام فقط)',
    streetWidthLabel: 'عرض الشارع (متر)',
    streetWidthPlaceholder: 'عرض الشارع كم متر؟',
    streetWidth1Label: 'الشارع الأول (متر)',
    streetWidth2Label: 'الشارع الثاني (متر)',
    isCornerLabel: 'ركنية (على شارعين)',
    ...
    deleteConfirm: 'هل أنت متأكد من حذف هذا العقار؟ لا يمكن التراجع عن هذا الإجراء.',
    statusLabel: 'حالة العقار',
    existingImages: 'صور العقار الحالية',
  },
  dashboard: {
    title: 'لوحة التحكم',
    analytics: 'التحليلات',
