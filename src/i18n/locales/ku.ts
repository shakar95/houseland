...
const ku: TranslationDict = {
  ...
  property: {
    ...
    photoFullscreen: 'پڕاوپڕی شاشە',
    photoClose: 'داخستن',
    photoZoomIn: 'گەورەکردنەوە',
    photoZoomOut: 'بچووککردنەوە',
    areaSqm: '{{count}} m²',
    ...
    floors: '{{count}} نهۆم',
    facing: 'ڕووەک',
    showMore: 'زیاتر ببینە',
    showLess: 'کەمتر ببینە',
    frontage: 'پێش',
    streetWidth: 'کۆڵان',
    corner: 'ڕوکن',
    nearestLandmark: 'نزیکترین شوێن',
  },
  enums: {
    FOR_SALE: 'فرۆشتن',
    FOR_RENT: 'کرێ',
  ...
  submit: {
    ...
    nearestLandmarkLabel: 'نزیکترین شوێن',
    nearestLandmarkPlaceholder: 'ناونیشان یان نزیکترین شوێن بنووسە...',
    ...
    frontageLabel: 'پێش (مەتر)',
    frontagePlaceholder: 'پێشی موڵکەکە چەند مەترە؟ (تەنها ژمارە)',
    streetWidthLabel: 'کۆڵان (مەتر)',
    streetWidthPlaceholder: 'کۆڵانی چەند مەتری؟',
    streetWidth1Label: 'کۆڵانی ١ (مەتر)',
    streetWidth2Label: 'کۆڵانی ٢ (مەتر)',
    isCornerLabel: 'ڕوکن (دوو ڕوو)',
    ...
    editTitle: 'دەستکاری کردنی موڵک',
    editProperty: 'دەستکاری کردنی موڵک',
    saveChanges: 'پاشەکەوتکردنی گۆڕانکارییەکان',
    saving: 'پاشەکەوت دەکرێت...',
    editSuccess: 'موڵکەکە بە سەرکەوتوویی نوێکرایەوە!',
    propertyNotFound: 'موڵکەکە نەدۆزرایەوە',
    deleteProperty: 'سڕینەوەی موڵک',
    deleteConfirm: 'دڵنیایت لە سڕینەوەی ئەم موڵکە؟ ئەم کردارە ناگەڕێتەوە.',
    statusLabel: 'دۆخی موڵک',
    existingImages: 'وێنە بەردەستەکانی موڵک',
  },
  dashboard: {
    title: 'داشبۆرد',
    analytics: 'ئامار',
