...
const links = [
  { to: '/dashboard', end: true, label: 'Analytics', icon: BarChart3 },
  { to: '/dashboard/properties', label: 'Properties', icon: Building2 },
  { to: '/dashboard/crm', label: 'CRM', icon: Users },
  { to: '/dashboard/staff', label: 'Staff', icon: UserCircle },
  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-8 lg:flex-row">
      <aside className="card-luxury shrink-0 p-4 lg:w-56">
        <h2 className="font-display text-xl text-gold-400">Dashboard</h2>
